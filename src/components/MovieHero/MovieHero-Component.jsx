    ...
    return (
        <>
            <div className='lg:hidden '>
                <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt='Movie Poster' className='m-4 rounded' style={{ width: "clac(100% - 2rem)" }} />
            </div>
            ...
            <div className='relative hidden lg:block ' style={{ height: "30rem" }}>
                ...
                <img src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt="Back groung" className='w-full h-full object-cover object-center' />
            </div>
